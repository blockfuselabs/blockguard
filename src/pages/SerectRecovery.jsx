...
const SecretRecovery = () => {
  ...
  return (
    <div className="h-[600px] flex flex-col items-center p-4 overflow-auto">
      ...
      <div className="mx-auto text-center w-full max-w-[400px] bg-primary-850 dark:bg-slate-600 rounded-[10px] p-4">
  {/* Hidden and visible phrases */}
  <div className="grid grid-cols-4 gap-2">
    {seedPhrases.map((phrase, index) => (
      <span
        key={index}
        className={`rounded-lg text-slate-700 dark:text-white bg-white py-2 text-sm break-words ${
